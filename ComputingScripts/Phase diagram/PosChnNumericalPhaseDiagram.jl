...
τ_chn_vec = LinRange(0.0, 9.0/N, num_points)
τ_rec = 0.0
phase_matrix = Array{Int}(undef, num_points, num_points)
...
file_name = joinpath(@__DIR__ ,"results/PostauChn_g_PhaseDiagram.jld2")
jldsave(file_name;
